...
WSBuiltInKeywords.verifyElementPropertyValue(response2, 'categories[0].id', '5')
WSBuiltInKeywords.verifyElementPropertyValue(response2, 'categories[0].name', 'Dom i Ogród')
