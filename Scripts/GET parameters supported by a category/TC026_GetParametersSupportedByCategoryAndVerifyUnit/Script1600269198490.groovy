...
WSBuiltInKeywords.verifyElementPropertyValue(response2, 'parameters[0].unit', 'null')
WSBuiltInKeywords.verifyElementPropertyValue(response2, 'parameters[1].unit', 'null')