...
WSBuiltInKeywords.verifyElementPropertyValue(response2, 'parameters[0].dictionary[0].value', 'Nowy')
WSBuiltInKeywords.verifyElementPropertyValue(response2, 'parameters[0].dictionary[1].value', 'Używany')