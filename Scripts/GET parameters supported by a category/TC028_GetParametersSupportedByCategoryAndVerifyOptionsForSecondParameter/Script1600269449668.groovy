...
WSBuiltInKeywords.verifyElementPropertyValue(response2, 'parameters[1].options.variantsAllowed', 'false')
WSBuiltInKeywords.verifyElementPropertyValue(response2, 'parameters[1].options.variantsEqual', 'false')
WSBuiltInKeywords.verifyElementPropertyValue(response2, 'parameters[1].options.ambiguousValueId', 'null')
WSBuiltInKeywords.verifyElementPropertyValue(response2, 'parameters[1].options.dependsOnParameterId', 'null')
WSBuiltInKeywords.verifyElementPropertyValue(response2, 'parameters[1].options.describesProduct', 'true')
WSBuiltInKeywords.verifyElementPropertyValue(response2, 'parameters[1].options.customValuesEnabled', 'false')
