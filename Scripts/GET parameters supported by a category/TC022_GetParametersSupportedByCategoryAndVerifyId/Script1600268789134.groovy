...
WSBuiltInKeywords.verifyElementPropertyValue(response2, 'parameters[0].id', '11323')
WSBuiltInKeywords.verifyElementPropertyValue(response2, 'parameters[1].id', '225693')
