...
WSBuiltInKeywords.verifyElementPropertyValue(response2, 'parameters[0].requiredForProduct', 'false')
WSBuiltInKeywords.verifyElementPropertyValue(response2, 'parameters[1].requiredForProduct', 'false')
