...
WSBuiltInKeywords.verifyElementPropertyValue(response2, 'parameters[0].name', 'Stan')
WSBuiltInKeywords.verifyElementPropertyValue(response2, 'parameters[1].name', 'EAN')
