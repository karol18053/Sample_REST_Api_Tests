...
WSBuiltInKeywords.verifyElementPropertyValue(response2, 'parameters[0].type', 'dictionary')
WSBuiltInKeywords.verifyElementPropertyValue(response2, 'parameters[1].type', 'string')
