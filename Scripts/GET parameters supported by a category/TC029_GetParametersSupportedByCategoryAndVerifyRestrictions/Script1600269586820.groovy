...
WSBuiltInKeywords.verifyElementPropertyValue(response2, 'parameters[0].restrictions.multipleChoices', 'false')
WSBuiltInKeywords.verifyElementPropertyValue(response2, 'parameters[1].restrictions.minLength', '8')
WSBuiltInKeywords.verifyElementPropertyValue(response2, 'parameters[1].restrictions.maxLength', '18')
WSBuiltInKeywords.verifyElementPropertyValue(response2, 'parameters[1].restrictions.allowedNumberOfValues', '1')