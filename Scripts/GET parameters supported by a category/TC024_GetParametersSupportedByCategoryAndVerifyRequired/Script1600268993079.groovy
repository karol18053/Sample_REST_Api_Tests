...
WSBuiltInKeywords.verifyElementPropertyValue(response2, 'parameters[0].required', 'true')
WSBuiltInKeywords.verifyElementPropertyValue(response2, 'parameters[1].required', 'false')
